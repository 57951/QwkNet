...
/// <summary>
/// Represents a command from the TODOOR.EXT file in a QWKE packet.
/// </summary>
/// <remarks>
/// <para>
/// TODOOR.EXT contains commands sent from the offline reader to the BBS door,
/// such as file attachment requests, file download requests, and control commands.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
public sealed class ToDoorCommand
{
  /// <summary>
  /// Gets the command type (e.g., "ATTACH", "REQUEST", "DROP", "ADD").
  /// </summary>
  /// <value>
  ...
  /// <summary>
  /// Gets the raw command line as it appeared in TODOOR.EXT.
  /// </summary>
  /// <value>
  ...
  /// <summary>
  /// Initialises a new instance of the <see cref="ToDoorCommand"/> class.
  /// </summary>
  ...
  /// </exception>
  public ToDoorCommand(string commandType, string parameters, string rawLine)
  {
    if (commandType == null)
    {
